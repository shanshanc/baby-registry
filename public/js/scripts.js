...
async function init() {
    ...
    // Initialize unified sidebar and simplified sticky header
    setTimeout(() => {
        initSidebar();
        initStickyHeader();
    }, 150);
...
// Export for testing (only available when imported in test environment)
export { initializeExpandCollapseControls };
